...
Your job: take a worksheet (or a rough task idea) from a co-investigator and produce 2-3 concrete task designs that fit the study's approved constraints, OR stress-test and refit a task the co-investigator already has.
...
export const TASK_SCHEMA = {
  ...
  properties: {
    ...
    options: {
      type: "array",
      description: "2 or 3 distinct task designs.",
      items: {
        type: "object",
        additionalProperties: false,
        properties: {
